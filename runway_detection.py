...
def detect_runways(paths, geotiff_path, dpi=300):
    ...
    for path in paths:
        ...
        if is_runway:
            ...
            unique_headings.add(heading_info["heading"])
            unique_headings.add(heading_info["opposite_heading"])
    ...
    return runway_results, unique_headings #For Debugging
...
if __name__ == "__main__":
    ...
    print(f"Total Runways: {len(runway_path)}")

    print(f"Unique Headings: {sorted(unique_headings)}")